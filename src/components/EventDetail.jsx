    ...
    <div className="container py-5 mt-5">
      <div className="row">
        <div className="col-12 mb-4">
          <button className="btn btn-outline-light-custom" onClick={() => navigate('/events')}>
            <i className="fas fa-arrow-left me-2"></i>Back to Events
          </button>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-lg-10 mx-auto">
          <div className="event-detail-card glass-card p-5 mb-5">
            {/* Event Header */}
            <div className="event-header mb-4">
              <div className="event-badge mb-3">Featured Event</div>
              <h1 className="event-title mb-3">{event.name}</h1>
            ...
            {/* Event Location */}
            <div className="event-location mb-5">
              ...
              <div className="ratio ratio-16x9 mb-3">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3023.621581479891!2d-74.00594238459418!3d40.71277527933012!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25a23f5e3c3a9%3A0x5f6c5eb5c4f34c4c!2sMadison%20Square%20Garden!5e0!3m2!1sen!2sus!4v1629990000000!5m2!1sen!2sus" 
            ...
            {/* Call to Action */}
            <div className="event-cta text-center">
              ...
              <div className="d-flex flex-column flex-md-row justify-content-center gap-3">
                ...
                <button className="btn btn-outline-light-custom btn-lg">
